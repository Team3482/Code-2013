...
public class OI {
    ...
    public JoystickButton spinDownButton;
    ...
    public OI() {
        ...
        armUpButton = new JoystickButton(joystick1, 6);
        armUpButton.whileHeld(new ArmUp());
        armDownButton = new JoystickButton(joystick1, 7);
        ...
        SmartDashboard.putData("SpinDown", new SpinDown());
