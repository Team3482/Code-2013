...
public class RobotMap {
    ...
    public static SpeedController shooterPiston;
	...
	LiveWindow.addActuator("Shooter", "Controller", (Victor) shooterController);
        ...
        shooterPID = new PIDController(1.0, 1.0, 1.0, 0.0, shooterEncoder, shooterController, 0.02);
	LiveWindow.addActuator("Shooter", "PID", shooterPID);
        shooterPID.setContinuous(false); shooterPID.setAbsoluteTolerance(0.2); 
        shooterPID.setOutputRange(-1.0, 1.0);        
        shooterPiston = new Victor(1, 8);
	LiveWindow.addActuator("Shooter", "Piston", (Victor) shooterPiston);
