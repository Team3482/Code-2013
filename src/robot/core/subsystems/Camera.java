...
public class Camera extends Subsystem {
    ...
    public double score(ColorImage img) throws NIVisionException {
    ...
    public double scoreXEdge(BinaryImage img, ParticleAnalysisReport report) {
    ...
    public double scoreYEdge(BinaryImage img, ParticleAnalysisReport report) {
        NIVision.Rect rect = new NIVision.Rect(report.boundingRectTop, report.boundingRectLeft,
                report.boundingRectHeight, report.boundingRectWidth);
        return 0.0;
    }
