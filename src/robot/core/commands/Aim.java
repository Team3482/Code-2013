...
public class  Aim extends Command {
    ...
    protected void execute() {
        try {
            cameraImage = Robot.camera.isFreshImage() ? Robot.camera.getImage(): cameraImage;
            int[] topScores = Robot.camera.getTargets(Robot.camera.score(cameraImage));
            System.out.println(Robot.camera.calculateOffset(topScores, 0));
    ...
    protected void end() {
        try {
            ...
            System.out.println(e);
            e.printStackTrace();  // Alex was here
        }
    }
